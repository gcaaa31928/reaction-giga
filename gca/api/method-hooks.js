 ...
 */
var MethodHooks = exports.MethodHooks = {};
 ...
 */
MethodHooks._handlers = _meteor.Meteor.isClient ? _meteor.Meteor.connection._methodHandlers : _meteor.Meteor.server.method_handlers;
...
MethodHooks._initializeHook = function (mapping, methodName, hookFunction) {
  ...
  MethodHooks._wrappers[methodName] = function () {
    ...
    var beforeResult = void 0;
    // Call the before hooks

    var beforeHooks = MethodHooks._beforeHooks[methodName];
    (0, _each3.default)(beforeHooks, function (beforeHook, hooksProcessed) {
    ...
    (0, _each3.default)(afterHooks, function (afterHook, hooksProcessed) {
      ...
      if ((0, _isUndefined3.default)(hookResult) && !(0, _isUndefined3.default)(methodResult)) {
        _meteor.Meteor._debug("Expected the after hook to return a value.");
      } else {
...
MethodHooks.beforeMethods = function (dict) {
  (0, _each3.default)(dict, function (v, k) {
